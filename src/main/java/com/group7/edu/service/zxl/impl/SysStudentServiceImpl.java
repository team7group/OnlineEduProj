...
import com.group7.edu.mapper.zxl.SysStudentMapperZxl;
 ...
 */
@Service("sysStudentServiceZxl")
public class SysStudentServiceImpl implements SysStudentService {
    @Resource
    SysStudentMapperZxl sysStudentMapperZxl;

    @Override
    public SysStudent findStudentById(int id) {

        SysStudent sysStudent = sysStudentMapperZxl.selectStudentByPrimaryKey(id);
    ...
    public R updateStudent(SysStudent sysStudent) {
        ...
        int i = sysStudentMapperZxl.updateByPrimaryKeySelective(sysStudent);
    ...
    public R verifyPwd(String pwd, int id) {
        ...
        SysStudent sysStudent = sysStudentMapperZxl.selectByPrimaryKey(id);
    ...
    public R updatePwd(String oldPwd,String newPwd, int id) {
        ...
        sysStudent.setId(id);
        int i = sysStudentMapperZxl.updatePwd(sysStudent);
    ...
    public R updateWechat(String wechat, int id) {
        ...
        sysStudent.setId(id);
        int i = sysStudentMapperZxl.updateWechat(sysStudent);
    ...
    public R updateQQ(String QQ, int id) {
        ...
        sysStudent.setQq(QQ);
        sysStudent.setId(id);
        int i = sysStudentMapperZxl.updateQQ(sysStudent);
    ...
    public R findsignIn(long id) {
        long checkinDays = sysStudentMapperZxl.findCheckinDays(id);
        // 查看有哪些天签到了
    ...
    public R signIn(long id) {
        ...
        int i = sysStudentMapperZxl.updateCheckinDays(s);
    ...
    public R updateHead(long id, MultipartFile file) {
        try{
            ...
            int i = sysStudentMapperZxl.updateIcon(sysStudent);
