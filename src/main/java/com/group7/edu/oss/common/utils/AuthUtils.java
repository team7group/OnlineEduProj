...
import com.group7.edu.oss.common.auth.PublicKey;
...
public class AuthUtils {
    ...
    public static PublicKey uploadPublicKey(String regionId, String accessKeyId, String accessKeySecret,
        ...
        UploadPublicKeyResponse.PublicKey pubKey = uploadPublicKeyResponse
                .getPublicKey();
    ...
    public static List<PublicKey> listPublicKeys(String regionId, String accessKeyId, String accessKeySecret)
        ...
        for (ListPublicKeysResponse.PublicKey publicKey : listPublicKeysResponse
                .getPublicKeys()) {
