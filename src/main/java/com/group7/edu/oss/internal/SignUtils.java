...
import static com.group7.edu.oss.common.utils.CodingUtils.assertTrue;
import static com.group7.edu.oss.internal.OSSConstants.DEFAULT_CHARSET_NAME;
import static com.group7.edu.oss.internal.OSSUtils.populateResponseHeaderParameters;
import static com.group7.edu.oss.internal.RequestParameters.*;
import static com.group7.edu.oss.internal.SignParameters.AUTHORIZATION_PREFIX;
...
public class SignUtils {
    ...
    public static String buildSignedURL(GeneratePresignedUrlRequest request, Credentials currentCreds, ClientConfiguration config, URI endpoint) {
        ...
        for (Entry<String, String> h : request.getUserMetadata().entrySet()) {
        ...
        if (request.getQueryParameter() != null && request.getQueryParameter().size() > 0) {
            for (Entry<String, String> entry : request.getQueryParameter().entrySet()) {
